  ...
  return (
    <div>
      ...
      <div className="card border-left-warning shadow h-100 py-2">
        <div className="card-body" onClick={() => handleNavigate('/applyloans')}>
          <div className="row no-gutters align-items-center">
            <div className="col mr-2">
              <div className="text-xs font-weight-bold text-warning text-uppercase mb-1">
                Apply for Loan
              </div>
              <div className="h5 mb-0 font-weight-bold text-gray-800">Apply for digital credit</div>
            </div>
            <div className="col-auto">
              <i className="fa fa-credit-card fa-2x text-gray-300"></i>
            </div>
          </div>
        </div>
      </div>
