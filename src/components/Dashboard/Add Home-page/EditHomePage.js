...
function EditHomePage({ id, onClose }) {
    ...
    VerifyLogin();
    useEffect(() => {
        axios.get(`http://localhost:8080/getInfoForEdit/${id}`)
            .then(res => {
                const data = res.data;
                setValues({
                    ...data,
    ...
    const handleSubmit = (event) => {
        ...
        axios.put(`http://localhost:8080/updateInfo/${id}`, values)
            .then(res => {
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit Info section</h5>
